...
const TOKENS = {
  ...
  fonts: {
    display: "Inter, ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, 'Apple Color Emoji','Segoe UI Emoji'",
...
// Goals: immersive feel, easy to edit, clean code that we refine as we go.
// Tech: Tailwind (utility-first), Framer Motion (micro-interactions).
// Structure: Navbar → Hero → Thesis → Events → Newsletter → CTA (Invest/Sponsor) → Footer
  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur-sm bg-black/40 border-b border-white/10">
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        <a href="#" className="font-semibold tracking-wide text-lg">VELVET</a>
        <div className="hidden md:flex items-center gap-6 text-sm">
          <a className="opacity-80 hover:opacity-100" href="#events">Events</a>
          <a className="opacity-80 hover:opacity-100" href="#thesis">About</a>
          <a className="opacity-80 hover:opacity-100" href="#invest">Invest</a>
          <a className="opacity-80 hover:opacity-100" href="#sponsor">Sponsor</a>
        </div>
        <a href="#tickets" className="inline-flex items-center rounded-2xl border border-white/15 bg-white/5 px-3 py-1.5 text-sm hover:bg-white/10 transition">
          Buy Tickets
        </a>
      </nav>
    </header>
      ...
      <div className="grid items-center gap-10 md:grid-cols-2">
        <div>
          ...
          <motion.div
            ...
            <a href="#tickets" className="rounded-2xl bg-white text-black px-5 py-3 text-sm font-medium shadow-[0_0_0_1px_rgba(255,255,255,0.12)] hover:shadow-[0_0_0_2px_rgba(255,255,255,0.25)] transition">
              Get Tickets
            </a>
            <a href="#newsletter" className="rounded-2xl border border-white/20 px-5 py-3 text-sm hover:bg-white/10 transition">
              Join the Newsletter
            </a>
          </motion.div>
    ...
    <section id="thesis" className="py-14 sm:py-24">
      <div className="grid gap-8 md:grid-cols-3">
        <div className="md:col-span-2">
          <SectionHeading kicker="Our Thesis">The future of art is multisensory</SectionHeading>
  ...
  return (
    <motion.div
      ...
      <div className="absolute inset-0" style={{
        background: "radial-gradient(120% 80% at 80% 20%, rgba(168,85,247,0.35), transparent 60%), radial-gradient(100% 60% at 20% 80%, rgba(59,130,246,0.3), transparent 60%), radial-gradient(80% 80% at 50% 50%, rgba(236,72,153,0.25), transparent 60%)"
      }} />
      <motion.div
        ...
        style={{ backgroundImage: "linear-gradient(90deg, rgba(255,255,255,0.05) 1px, transparent 1px)", backgroundSize: "8px 100%" }}
      />
    </motion.div>
  );
}
